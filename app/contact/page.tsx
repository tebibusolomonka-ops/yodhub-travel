...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-[#f4f7fb] text-[#071e42]">
      <InnerHero eyebrow="Contact" title="Start with the right service." copy="Call, message us on Telegram, or join our channels. Please don't send passports or other documents until we ask for them." />
