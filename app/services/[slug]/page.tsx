    ...
    <main className="min-h-screen bg-[#f4f7fb] text-[#071e42]">
      ...
      <section className="mx-auto grid w-full max-w-[1180px] gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[.8fr_1.2fr] lg:gap-16 lg:py-28">
        ...
        <div className="rounded-[2rem] bg-[#071e42] p-7 text-white sm:p-10">
          ...
          <h2 className="mt-5 text-3xl font-black tracking-[-.035em]">How the mock journey works</h2>
          ...
          <p className="mt-6 text-sm leading-6 text-white/55">This website is currently a prototype. It does not collect documents or send applications to the consultancy.</p>
        </div>
      </section>
